...
const CourseCard: React.FC<CourseProps> = ({courseName, onCourseDeleted}) => {
  ...
  return (
    <div className='cursor-pointer bg-[white] rounded-lg  px-7 py-3 sm:mr-3 flex flex-col transition-transform duration-300 ease-in-out transform hover:scale-105 hover:bg-[#F6F6F6] w-[300px] border-2 my-2' onClick={() =>  router.push(`/domains?query=${courseName}`)}>
